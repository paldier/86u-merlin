...
Currently available applets include:
	...
	ftpget, getopt, grep, gunzip, gzip, halt, head, ifconfig, insmod,
	ionice, kill, killall, klogd, less, ln, logger, login, logread, ls,
	lsmod, lsusb, md5sum, mdev, mkdir, mknod, mkswap, modprobe, more,
	mount, mv, nc, netstat, nice, nohup, nslookup, pidof, ping, ping6,
	poweroff, printf, ps, pwd, pwdx, readlink, reboot, remove-shell,
	renice, rm, rmdir, rmmod, route, sed, setconsole, sh, shuf, sleep,
	smemcap, sort, split, start-stop-daemon, strings, stty, swapoff,
	swapon, sync, syslogd, tail, tar, taskset, tee, telnetd, test, tftp,
